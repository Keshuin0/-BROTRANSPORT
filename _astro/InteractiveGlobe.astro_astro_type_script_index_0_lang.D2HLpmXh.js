...
void main() {
	...
	`}class Tl extends on{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new gl(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const df={[Ko]:"Linear",[Zo]:"Reinhard",[jo]:"Cineon",[$o]:"ACESFilmic",[Qo]:"AgX",[el]:"Neutral",[Jo]:"Custom"};function ff(i,e){const t=df[e];return t===void 0?(Te("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const mr=new I;function pf(){Ve.getLuminanceCoefficients(mr);const i=mr.x.toFixed(4),e=mr.y.toFixed(4),t=mr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,Zf=[new I(1,0,0),new I(-1,0,0),new I(0,1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1)],jf=[new I(0,-1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1),new I(0,-1,0),new I(0,-1,0)],Vo=new rt,Ni=new I,ys=new I;function $f(i,e,t){let n=new wa;const r=new Ce,s=new Ce,a=new ct,o=new ah,c=new oh,l={},d=t.maxTextureSize,p={[On]:Ut,[Ut]:On,[_n]:_n},h=new hn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ce},radius:{value:4}},vertexShader:qf,fragmentShader:Kf}),f=h.clone();f.defines.HORIZONTAL_PASS=1;const _=new Yt;_.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new Pt(_,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Mr;let u=this.type;this.render=function(T,P,v){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;this.type===Vl&&(Te("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Mr);const A=i.getRenderTarget(),F=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),G=i.state;G.setBlending(vn),G.buffers.depth.getReversed()===!0?G.buffers.color.setClear(0,0,0,0):G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const X=u!==this.type;X&&P.traverse(function(Z){Z.material&&(Array.isArray(Z.material)?Z.material.forEach(U=>U.needsUpdate=!0):Z.material.needsUpdate=!0)});for(let Z=0,U=T.length;Z<U;Z++){const H=T[Z],z=H.shadow;if(z===void 0){Te("WebGLShadowMap:",H,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const J=z.getFrameExtents();r.multiply(J),s.copy(z.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/J.x),r.x=s.x*J.x,z.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/J.y),r.y=s.y*J.y,z.mapSize.y=s.y));const Q=i.state.buffers.depth.getReversed();if(z.camera._reversedDepth=Q,z.map===null||X===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Fi){if(H.isPointLight){Te("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new on(r.x,r.y,{format:$n,type:Sn,minFilter:yt,magFilter:yt,generateMipmaps:!1}),z.map.texture.name=H.name+".shadowMap",z.map.depthTexture=new Ei(r.x,r.y,rn),z.map.depthTexture.name=H.name+".shadowMapDepth",z.map.depthTexture.format=yn,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=St,z.map.depthTexture.magFilter=St}else H.isPointLight?(z.map=new Tl(r.x),z.map.depthTexture=new Kc(r.x,cn)):(z.map=new on(r.x,r.y),z.map.depthTexture=new Ei(r.x,r.y,cn)),z.map.depthTexture.name=H.name+".shadowMap",z.map.depthTexture.format=yn,this.type===Mr?(z.map.depthTexture.compareFunction=Q?Ta:Ea,z.map.depthTexture.minFilter=yt,z.map.depthTexture.magFilter=yt):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=St,z.map.depthTexture.magFilter=St);z.camera.updateProjectionMatrix()}const ce=z.map.isWebGLCubeRenderTarget?6:1;for(let xe=0;xe<ce;xe++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,xe),i.clear();else{xe===0&&(i.setRenderTarget(z.map),i.clear());const ye=z.getViewport(xe);a.set(s.x*ye.x,s.y*ye.y,s.x*ye.z,s.y*ye.w),G.viewport(a)}if(H.isPointLight){const ye=z.camera,He=z.matrix,Ke=H.distance||ye.far;Ke!==ye.far&&(ye.far=Ke,ye.updateProjectionMatrix()),Ni.setFromMatrixPosition(H.matrixWorld),ye.position.copy(Ni),ys.copy(ye.position),ys.add(Zf[xe]),ye.up.copy(jf[xe]),ye.lookAt(ys),ye.updateMatrixWorld(),He.makeTranslation(-Ni.x,-Ni.y,-Ni.z),Vo.multiplyMatrices(ye.projectionMatrix,ye.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Vo,ye.coordinateSystem,ye.reversedDepth)}else z.updateMatrices(H);n=z.getFrustum(),E(P,v,z.camera,H,this.type)}z.isPointLightShadow!==!0&&this.type===Fi&&y(z,v),z.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(A,F,R)};function y(T,P){const v=e.update(S);h.defines.VSM_SAMPLES!==T.blurSamples&&(h.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new on(r.x,r.y,{format:$n,type:Sn})),h.uniforms.shadow_pass.value=T.map.depthTexture,h.uniforms.resolution.value=T.mapSize,h.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(P,null,v,h,S,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(P,null,v,f,S,null)}function b(T,P,v,A){let F=null;const R=v.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(R!==void 0)F=R;else if(F=v.isPointLight===!0?c:o,i.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const G=F.uuid,X=P.uuid;let Z=l[G];Z===void 0&&(Z={},l[G]=Z);let U=Z[X];U===void 0&&(U=F.clone(),Z[X]=U,P.addEventListener("dispose",D)),F=U}if(F.visible=P.visible,F.wireframe=P.wireframe,A===Fi?F.side=P.shadowSide!==null?P.shadowSide:P.side:F.side=P.shadowSide!==null?P.shadowSide:p[P.side],F.alphaMap=P.alphaMap,F.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,F.map=P.map,F.clipShadows=P.clipShadows,F.clippingPlanes=P.clippingPlanes,F.clipIntersection=P.clipIntersection,F.displacementMap=P.displacementMap,F.displacementScale=P.displacementScale,F.displacementBias=P.displacementBias,F.wireframeLinewidth=P.wireframeLinewidth,F.linewidth=P.linewidth,v.isPointLight===!0&&F.isMeshDistanceMaterial===!0){const G=i.properties.get(F);G.light=v}return F}function E(T,P,v,A,F){if(T.visible===!1)return;if(T.layers.test(P.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&F===Fi)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,T.matrixWorld);const X=e.update(T),Z=T.material;if(Array.isArray(Z)){const U=X.groups;for(let H=0,z=U.length;H<z;H++){const J=U[H],Q=Z[J.materialIndex];if(Q&&Q.visible){const ce=b(T,Q,A,F);T.onBeforeShadow(i,T,P,v,X,ce,J),i.renderBufferDirect(v,null,X,ce,T,J),T.onAfterShadow(i,T,P,v,X,ce,J)}}}else if(Z.visible){const U=b(T,Z,A,F);T.onBeforeShadow(i,T,P,v,X,U,null),i.renderBufferDirect(v,null,X,U,T,null),T.onAfterShadow(i,T,P,v,X,U,null)}}const G=T.children;for(let X=0,Z=G.length;X<Z;X++)E(G[X],P,v,A,F)}function D(T){T.target.removeEventListener("dispose",D);for(const v in l){const A=l[v],F=T.target.uuid;F in A&&(A[F].dispose(),delete A[F])}}}function Jf(i,e){function t(){let w=!1;const ne=new ct;let W=null;const pe=new ct(0,0,0,0);return{setMask:function(se){W!==se&&!w&&(i.colorMask(se,se,se,se),W=se)},setLocked:function(se){w=se},setClear:function(se,j,Me,De,ht){ht===!0&&(se*=De,j*=De,Me*=De),ne.set(se,j,Me,De),pe.equals(ne)===!1&&(i.clearColor(se,j,Me,De),pe.copy(ne))},reset:function(){w=!1,W=null,pe.set(-1,0,0,0)}}}function n(){let w=!1,ne=!1,W=null,pe=null,se=null;return{setReversed:function(j){if(ne!==j){const Me=e.get("EXT_clip_control");j?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),ne=j;const De=se;se=null,this.setClear(De)}},getReversed:function(){return ne},setTest:function(j){j?ie(i.DEPTH_TEST):be(i.DEPTH_TEST)},setMask:function(j){W!==j&&!w&&(i.depthMask(j),W=j)},setFunc:function(j){if(ne&&(j=Mc[j]),pe!==j){switch(j){case Rs:i.depthFunc(i.NEVER);break;case ws:i.depthFunc(i.ALWAYS);break;case Ps:i.depthFunc(i.LESS);break;case Si:i.depthFunc(i.LEQUAL);break;case Cs:i.depthFunc(i.EQUAL);break;case Ds:i.depthFunc(i.GEQUAL);break;case Ls:i.depthFunc(i.GREATER);break;case Is:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}pe=j}},setLocked:function(j){w=j},setClear:function(j){se!==j&&(se=j,ne&&(j=1-j),i.clearDepth(j))},reset:function(){w=!1,W=null,pe=null,se=null,ne=!1}}}function r(){let w=!1,ne=null,W=null,pe=null,se=null,j=null,Me=null,De=null,ht=null;return{setTest:function(je){w||(je?ie(i.STENCIL_TEST):be(i.STENCIL_TEST))},setMask:function(je){ne!==je&&!w&&(i.stencilMask(je),ne=je)},setFunc:function(je,un,Jt){(W!==je||pe!==un||se!==Jt)&&(i.stencilFunc(je,un,Jt),W=je,pe=un,se=Jt)},setOp:function(je,un,Jt){(j!==je||Me!==un||De!==Jt)&&(i.stencilOp(je,un,Jt),j=je,Me=un,De=Jt)},setLocked:function(je){w=je},setClear:function(je){ht!==je&&(i.clearStencil(je),ht=je)},reset:function(){w=!1,ne=null,W=null,pe=null,se=null,j=null,Me=null,De=null,ht=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let d={},p={},h={},f=new WeakMap,_=[],S=null,m=!1,u=null,y=null,b=null,E=null,D=null,T=null,P=null,v=new Xe(0,0,0),A=0,F=!1,R=null,G=null,X=null,Z=null,U=null;const H=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,J=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(Q)[1]),z=J>=1):Q.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),z=J>=2);let ce=null,xe={};const ye=i.getParameter(i.SCISSOR_BOX),He=i.getParameter(i.VIEWPORT),Ke=new ct().fromArray(ye),Ie=new ct().fromArray(He);function K(w,ne,W,pe){const se=new Uint8Array(4),j=i.createTexture();i.bindTexture(w,j),i.texParameteri(w,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(w,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Me=0;Me<W;Me++)w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY?i.texImage3D(ne,0,i.RGBA,1,1,pe,0,i.RGBA,i.UNSIGNED_BYTE,se):i.texImage2D(ne+Me,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,se);return j}const de={};de[i.TEXTURE_2D]=K(i.TEXTURE_2D,i.TEXTURE_2D,1),de[i.TEXTURE_CUBE_MAP]=K(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),de[i.TEXTURE_2D_ARRAY]=K(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),de[i.TEXTURE_3D]=K(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ie(i.DEPTH_TEST),a.setFunc(Si),mt(!1),at(za),ie(i.CULL_FACE),it(vn);function ie(w){d[w]!==!0&&(i.enable(w),d[w]=!0)}function be(w){d[w]!==!1&&(i.disable(w),d[w]=!1)}function we(w,ne){return h[w]!==ne?(i.bindFramebuffer(w,ne),h[w]=ne,w===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ne),w===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ne),!0):!1}function Ae(w,ne){let W=_,pe=!1;if(w){W=f.get(ne),W===void 0&&(W=[],f.set(ne,W));const se=w.textures;if(W.length!==se.length||W[0]!==i.COLOR_ATTACHMENT0){for(let j=0,Me=se.length;j<Me;j++)W[j]=i.COLOR_ATTACHMENT0+j;W.length=se.length,pe=!0}}else W[0]!==i.BACK&&(W[0]=i.BACK,pe=!0);pe&&i.drawBuffers(W)}function st(w){return S!==w?(i.useProgram(w),S=w,!0):!1}const ze={[Yn]:i.FUNC_ADD,[kl]:i.FUNC_SUBTRACT,[Wl]:i.FUNC_REVERSE_SUBTRACT};ze[Xl]=i.MIN,ze[Yl]=i.MAX;const Ze={[ql]:i.ZERO,[Kl]:i.ONE,[Zl]:i.SRC_COLOR,[bs]:i.SRC_ALPHA,[tc]:i.SRC_ALPHA_SATURATE,[Ql]:i.DST_COLOR,[$l]:i.DST_ALPHA,[jl]:i.ONE_MINUS_SRC_COLOR,[As]:i.ONE_MINUS_SRC_ALPHA,[ec]:i.ONE_MINUS_DST_COLOR,[Jl]:i.ONE_MINUS_DST_ALPHA,[nc]:i.CONSTANT_COLOR,[ic]:i.ONE_MINUS_CONSTANT_COLOR,[rc]:i.CONSTANT_ALPHA,[sc]:i.ONE_MINUS_CONSTANT_ALPHA};function it(w,ne,W,pe,se,j,Me,De,ht,je){if(w===vn){m===!0&&(be(i.BLEND),m=!1);return}if(m===!1&&(ie(i.BLEND),m=!0),w!==Hl){if(w!==u||je!==F){if((y!==Yn||D!==Yn)&&(i.blendEquation(i.FUNC_ADD),y=Yn,D=Yn),je)switch(w){case xi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ga:i.blendFunc(i.ONE,i.ONE);break;case Va:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ha:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:We("WebGLState: Invalid blending: ",w);break}else switch(w){case xi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ga:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Va:We("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ha:We("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:We("WebGLState: Invalid blending: ",w);break}b=null,E=null,T=null,P=null,v.set(0,0,0),A=0,u=w,F=je}return}se=se||ne,j=j||W,Me=Me||pe,(ne!==y||se!==D)&&(i.blendEquationSeparate(ze[ne],ze[se]),y=ne,D=se),(W!==b||pe!==E||j!==T||Me!==P)&&(i.blendFuncSeparate(Ze[W],Ze[pe],Ze[j],Ze[Me]),b=W,E=pe,T=j,P=Me),(De.equals(v)===!1||ht!==A)&&(i.blendColor(De.r,De.g,De.b,ht),v.copy(De),A=ht),u=w,F=!1}function Be(w,ne){w.side===_n?be(i.CULL_FACE):ie(i.CULL_FACE);let W=w.side===Ut;ne&&(W=!W),mt(W),w.blending===xi&&w.transparent===!1?it(vn):it(w.blending,w.blendEquation,w.blendSrc,w.blendDst,w.blendEquationAlpha,w.blendSrcAlpha,w.blendDstAlpha,w.blendColor,w.blendAlpha,w.premultipliedAlpha),a.setFunc(w.depthFunc),a.setTest(w.depthTest),a.setMask(w.depthWrite),s.setMask(w.colorWrite);const pe=w.stencilWrite;o.setTest(pe),pe&&(o.setMask(w.stencilWriteMask),o.setFunc(w.stencilFunc,w.stencilRef,w.stencilFuncMask),o.setOp(w.stencilFail,w.stencilZFail,w.stencilZPass)),C(w.polygonOffset,w.polygonOffsetFactor,w.polygonOffsetUnits),w.alphaToCoverage===!0?ie(i.SAMPLE_ALPHA_TO_COVERAGE):be(i.SAMPLE_ALPHA_TO_COVERAGE)}function mt(w){R!==w&&(w?i.frontFace(i.CW):i.frontFace(i.CCW),R=w)}function at(w){w!==zl?(ie(i.CULL_FACE),w!==G&&(w===za?i.cullFace(i.BACK):w===Gl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):be(i.CULL_FACE),G=w}function Nt(w){w!==X&&(z&&i.lineWidth(w),X=w)}function C(w,ne,W){w?(ie(i.POLYGON_OFFSET_FILL),(Z!==ne||U!==W)&&(Z=ne,U=W,a.getReversed()&&(ne=-ne),i.polygonOffset(ne,W))):be(i.POLYGON_OFFSET_FILL)}function gt(w){w?ie(i.SCISSOR_TEST):be(i.SCISSOR_TEST)}function Ge(w){w===void 0&&(w=i.TEXTURE0+H-1),ce!==w&&(i.activeTexture(w),ce=w)}function tt(w,ne,W){W===void 0&&(ce===null?W=i.TEXTURE0+H-1:W=ce);let pe=xe[W];pe===void 0&&(pe={type:void 0,texture:void 0},xe[W]=pe),(pe.type!==w||pe.texture!==ne)&&(ce!==W&&(i.activeTexture(W),ce=W),i.bindTexture(w,ne||de[w]),pe.type=w,pe.texture=ne)}function oe(){const w=xe[ce];w!==void 0&&w.type!==void 0&&(i.bindTexture(w.type,null),w.type=void 0,w.texture=void 0)}function ot(){try{i.compressedTexImage2D(...arguments)}catch(w){We("WebGLState:",w)}}function M(){try{i.compressedTexImage3D(...arguments)}catch(w){We("WebGLState:",w)}}function g(){try{i.texSubImage2D(...arguments)}catch(w){We("WebGLState:",w)}}function N(){try{i.texSubImage3D(...arguments)}catch(w){We("WebGLState:",w)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(w){We("WebGLState:",w)}}function $(){try{i.compressedTexSubImage3D(...arguments)}catch(w){We("WebGLState:",w)}}function ee(){try{i.texStorage2D(...arguments)}catch(w){We("WebGLState:",w)}}function ae(){try{i.texStorage3D(...arguments)}catch(w){We("WebGLState:",w)}}function k(){try{i.texImage2D(...arguments)}catch(w){We("WebGLState:",w)}}function q(){try{i.texImage3D(...arguments)}catch(w){We("WebGLState:",w)}}function fe(w){return p[w]!==void 0?p[w]:i.getParameter(w)}function ge(w,ne){p[w]!==ne&&(i.pixelStorei(w,ne),p[w]=ne)}function re(w){Ke.equals(w)===!1&&(i.scissor(w.x,w.y,w.z,w.w),Ke.copy(w))}function te(w){Ie.equals(w)===!1&&(i.viewport(w.x,w.y,w.z,w.w),Ie.copy(w))}function Re(w,ne){let W=l.get(ne);W===void 0&&(W=new WeakMap,l.set(ne,W));let pe=W.get(w);pe===void 0&&(pe=i.getUniformBlockIndex(ne,w.name),W.set(w,pe))}function Ue(w,ne){const pe=l.get(ne).get(w);c.get(ne)!==pe&&(i.uniformBlockBinding(ne,pe,w.__bindingPointIndex),c.set(ne,pe))}function Ye(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},p={},ce=null,xe={},h={},f=new WeakMap,_=[],S=null,m=!1,u=null,y=null,b=null,E=null,D=null,T=null,P=null,v=new Xe(0,0,0),A=0,F=!1,R=null,G=null,X=null,Z=null,U=null,Ke.set(0,0,i.canvas.width,i.canvas.height),Ie.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ie,disable:be,bindFramebuffer:we,drawBuffers:Ae,useProgram:st,setBlending:it,setMaterial:Be,setFlipSided:mt,setCullFace:at,setLineWidth:Nt,setPolygonOffset:C,setScissorTest:gt,activeTexture:Ge,bindTexture:tt,unbindTexture:oe,compressedTexImage2D:ot,compressedTexImage3D:M,texImage2D:k,texImage3D:q,pixelStorei:ge,getParameter:fe,updateUBOMapping:Re,uniformBlockBinding:Ue,texStorage2D:ee,texStorage3D:ae,texSubImage2D:g,texSubImage3D:N,compressedTexSubImage2D:Y,compressedTexSubImage3D:$,scissor:re,viewport:te,reset:Ye}}function Qf(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ce,d=new WeakMap,p=new Set;let h;const f=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(M,g){return _?new OffscreenCanvas(M,g):Dr("canvas")}function m(M,g,N){let Y=1;const $=ot(M);if(($.width>N||$.height>N)&&(Y=N/Math.max($.width,$.height)),Y<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){const ee=Math.floor(Y*$.width),ae=Math.floor(Y*$.height);h===void 0&&(h=S(ee,ae));const k=g?S(ee,ae):h;return k.width=ee,k.height=ae,k.getContext("2d").drawImage(M,0,0,ee,ae),Te("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+ee+"x"+ae+")."),k}else return"data"in M&&Te("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),M;return M}function u(M){return M.generateMipmaps}function y(M){i.generateMipmap(M)}function b(M){return M.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?i.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(M,g,N,Y,$,ee=!1){if(M!==null){if(i[M]!==void 0)return i[M];Te("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let ae;Y&&(ae=e.get("EXT_texture_norm16"),ae||Te("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let k=g;if(g===i.RED&&(N===i.FLOAT&&(k=i.R32F),N===i.HALF_FLOAT&&(k=i.R16F),N===i.UNSIGNED_BYTE&&(k=i.R8),N===i.UNSIGNED_SHORT&&ae&&(k=ae.R16_EXT),N===i.SHORT&&ae&&(k=ae.R16_SNORM_EXT)),g===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(k=i.R8UI),N===i.UNSIGNED_SHORT&&(k=i.R16UI),N===i.UNSIGNED_INT&&(k=i.R32UI),N===i.BYTE&&(k=i.R8I),N===i.SHORT&&(k=i.R16I),N===i.INT&&(k=i.R32I)),g===i.RG&&(N===i.FLOAT&&(k=i.RG32F),N===i.HALF_FLOAT&&(k=i.RG16F),N===i.UNSIGNED_BYTE&&(k=i.RG8),N===i.UNSIGNED_SHORT&&ae&&(k=ae.RG16_EXT),N===i.SHORT&&ae&&(k=ae.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(N===i.UNSIGNED_BYTE&&(k=i.RG8UI),N===i.UNSIGNED_SHORT&&(k=i.RG16UI),N===i.UNSIGNED_INT&&(k=i.RG32UI),N===i.BYTE&&(k=i.RG8I),N===i.SHORT&&(k=i.RG16I),N===i.INT&&(k=i.RG32I)),g===i.RGB_INTEGER&&(N===i.UNSIGNED_BYTE&&(k=i.RGB8UI),N===i.UNSIGNED_SHORT&&(k=i.RGB16UI),N===i.UNSIGNED_INT&&(k=i.RGB32UI),N===i.BYTE&&(k=i.RGB8I),N===i.SHORT&&(k=i.RGB16I),N===i.INT&&(k=i.RGB32I)),g===i.RGBA_INTEGER&&(N===i.UNSIGNED_BYTE&&(k=i.RGBA8UI),N===i.UNSIGNED_SHORT&&(k=i.RGBA16UI),N===i.UNSIGNED_INT&&(k=i.RGBA32UI),N===i.BYTE&&(k=i.RGBA8I),N===i.SHORT&&(k=i.RGBA16I),N===i.INT&&(k=i.RGBA32I)),g===i.RGB&&(N===i.UNSIGNED_SHORT&&ae&&(k=ae.RGB16_EXT),N===i.SHORT&&ae&&(k=ae.RGB16_SNORM_EXT),N===i.UNSIGNED_INT_5_9_9_9_REV&&(k=i.RGB9_E5),N===i.UNSIGNED_INT_10F_11F_11F_REV&&(k=i.R11F_G11F_B10F)),g===i.RGBA){const q=ee?Cr:Ve.getTransfer($);N===i.FLOAT&&(k=i.RGBA32F),N===i.HALF_FLOAT&&(k=i.RGBA16F),N===i.UNSIGNED_BYTE&&(k=q===qe?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT&&ae&&(k=ae.RGBA16_EXT),N===i.SHORT&&ae&&(k=ae.RGBA16_SNORM_EXT),N===i.UNSIGNED_SHORT_4_4_4_4&&(k=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(k=i.RGB5_A1)}return(k===i.R16F||k===i.R32F||k===i.RG16F||k===i.RG32F||k===i.RGBA16F||k===i.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function D(M,g){let N;return M?g===null||g===cn||g===zi?N=i.DEPTH24_STENCIL8:g===rn?N=i.DEPTH32F_STENCIL8:g===Bi&&(N=i.DEPTH24_STENCIL8,Te("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===cn||g===zi?N=i.DEPTH_COMPONENT24:g===rn?N=i.DEPTH_COMPONENT32F:g===Bi&&(N=i.DEPTH_COMPONENT16),N}function T(M,g){return u(M)===!0||M.isFramebufferTexture&&M.minFilter!==St&&M.minFilter!==yt?Math.log2(Math.max(g.width,g.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?g.mipmaps.length:1}function P(M){const g=M.target;g.removeEventListener("dispose",P),A(g),g.isVideoTexture&&d.delete(g),g.isHTMLTexture&&p.delete(g)}function v(M){const g=M.target;g.removeEventListener("dispose",v),R(g)}function A(M){const g=n.get(M);if(g.__webglInit===void 0)return;const N=M.source,Y=f.get(N);if(Y){const $=Y[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&F(M),Object.keys(Y).length===0&&f.delete(N)}n.remove(M)}function F(M){const g=n.get(M);i.deleteTexture(g.__webglTexture);const N=M.source,Y=f.get(N);delete Y[g.__cacheKey],a.memory.textures--}function R(M){const g=n.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),n.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(g.__webglFramebuffer[Y]))for(let $=0;$<g.__webglFramebuffer[Y].length;$++)i.deleteFramebuffer(g.__webglFramebuffer[Y][$]);else i.deleteFramebuffer(g.__webglFramebuffer[Y]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[Y])}else{if(Array.isArray(g.__webglFramebuffer))for(let Y=0;Y<g.__webglFramebuffer.length;Y++)i.deleteFramebuffer(g.__webglFramebuffer[Y]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let Y=0;Y<g.__webglColorRenderbuffer.length;Y++)g.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[Y]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const N=M.textures;for(let Y=0,$=N.length;Y<$;Y++){const ee=n.get(N[Y]);ee.__webglTexture&&(i.deleteTexture(ee.__webglTexture),a.memory.textures--),n.remove(N[Y])}n.remove(M)}let G=0;function X(){G=0}function Z(){return G}function U(M){G=M}function H(){const M=G;return M>=r.maxTextures&&Te("WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+r.maxTextures),G+=1,M}function z(M){const g=[];return g.push(M.wrapS),g.push(M.wrapT),g.push(M.wrapR||0),g.push(M.magFilter),g.push(M.minFilter),g.push(M.anisotropy),g.push(M.internalFormat),g.push(M.format),g.push(M.type),g.push(M.generateMipmaps),g.push(M.premultiplyAlpha),g.push(M.flipY),g.push(M.unpackAlignment),g.push(M.colorSpace),g.join()}function J(M,g){const N=n.get(M);if(M.isVideoTexture&&tt(M),M.isRenderTargetTexture===!1&&M.isExternalTexture!==!0&&M.version>0&&N.__version!==M.version){const Y=M.image;if(Y===null)Te("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Te("WebGLRenderer: Texture marked for update but image is incomplete");else{be(N,M,g);return}}else M.isExternalTexture&&(N.__webglTexture=M.sourceTexture?M.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+g)}function Q(M,g){const N=n.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&N.__version!==M.version){be(N,M,g);return}else M.isExternalTexture&&(N.__webglTexture=M.sourceTexture?M.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+g)}function ce(M,g){const N=n.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&N.__version!==M.version){be(N,M,g);return}t.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+g)}function xe(M,g){const N=n.get(M);if(M.isCubeDepthTexture!==!0&&M.version>0&&N.__version!==M.version){we(N,M,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+g)}const ye={[Us]:i.REPEAT,[xn]:i.CLAMP_TO_EDGE,[Ns]:i.MIRRORED_REPEAT},He={[St]:i.NEAREST,[lc]:i.NEAREST_MIPMAP_NEAREST,[Yi]:i.NEAREST_MIPMAP_LINEAR,[yt]:i.LINEAR,[Wr]:i.LINEAR_MIPMAP_NEAREST,[Nn]:i.LINEAR_MIPMAP_LINEAR},Ke={[uc]:i.NEVER,[gc]:i.ALWAYS,[dc]:i.LESS,[Ea]:i.LEQUAL,[fc]:i.EQUAL,[Ta]:i.GEQUAL,[pc]:i.GREATER,[mc]:i.NOTEQUAL};function Ie(M,g){if(g.type===rn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===yt||g.magFilter===Wr||g.magFilter===Yi||g.magFilter===Nn||g.minFilter===yt||g.minFilter===Wr||g.minFilter===Yi||g.minFilter===Nn)&&Te("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(M,i.TEXTURE_WRAP_S,ye[g.wrapS]),i.texParameteri(M,i.TEXTURE_WRAP_T,ye[g.wrapT]),(M===i.TEXTURE_3D||M===i.TEXTURE_2D_ARRAY)&&i.texParameteri(M,i.TEXTURE_WRAP_R,ye[g.wrapR]),i.texParameteri(M,i.TEXTURE_MAG_FILTER,He[g.magFilter]),i.texParameteri(M,i.TEXTURE_MIN_FILTER,He[g.minFilter]),g.compareFunction&&(i.texParameteri(M,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(M,i.TEXTURE_COMPARE_FUNC,Ke[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===St||g.minFilter!==Yi&&g.minFilter!==Nn||g.type===rn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const N=e.get("EXT_texture_filter_anisotropic");i.texParameterf(M,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function K(M,g){let N=!1;M.__webglInit===void 0&&(M.__webglInit=!0,g.addEventListener("dispose",P));const Y=g.source;let $=f.get(Y);$===void 0&&($={},f.set(Y,$));const ee=z(g);if(ee!==M.__cacheKey){$[ee]===void 0&&($[ee]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,N=!0),$[ee].usedTimes++;const ae=$[M.__cacheKey];ae!==void 0&&($[M.__cacheKey].usedTimes--,ae.usedTimes===0&&F(g)),M.__cacheKey=ee,M.__webglTexture=$[ee].texture}return N}function de(M,g,N){return Math.floor(Math.floor(M/N)/g)}function ie(M,g,N,Y){const ee=M.updateRanges;if(ee.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,N,Y,g.data);else{ee.sort((ge,re)=>ge.start-re.start);let ae=0;for(let ge=1;ge<ee.length;ge++){const re=ee[ae],te=ee[ge],Re=re.start+re.count,Ue=de(te.start,g.width,4),Ye=de(re.start,g.width,4);te.start<=Re+1&&Ue===Ye&&de(te.start+te.count-1,g.width,4)===Ue?re.count=Math.max(re.count,te.start+te.count-re.start):(++ae,ee[ae]=te)}ee.length=ae+1;const k=t.getParameter(i.UNPACK_ROW_LENGTH),q=t.getParameter(i.UNPACK_SKIP_PIXELS),fe=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let ge=0,re=ee.length;ge<re;ge++){const te=ee[ge],Re=Math.floor(te.start/4),Ue=Math.ceil(te.count/4),Ye=Re%g.width,w=Math.floor(Re/g.width),ne=Ue,W=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Ye),t.pixelStorei(i.UNPACK_SKIP_ROWS,w),t.texSubImage2D(i.TEXTURE_2D,0,Ye,w,ne,W,N,Y,g.data)}M.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,k),t.pixelStorei(i.UNPACK_SKIP_PIXELS,q),t.pixelStorei(i.UNPACK_SKIP_ROWS,fe)}}function be(M,g,N){let Y=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(Y=i.TEXTURE_3D);const $=K(M,g),ee=g.source;t.bindTexture(Y,M.__webglTexture,i.TEXTURE0+N);const ae=n.get(ee);if(ee.version!==ae.__version||$===!0){if(t.activeTexture(i.TEXTURE0+N),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const W=Ve.getPrimaries(Ve.workingColorSpace),pe=g.colorSpace===Un?null:Ve.getPrimaries(g.colorSpace),se=g.colorSpace===Un||W===pe?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,se)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let q=m(g.image,!1,r.maxTextureSize);q=oe(g,q);const fe=s.convert(g.format,g.colorSpace),ge=s.convert(g.type);let re=E(g.internalFormat,fe,ge,g.normalized,g.colorSpace,g.isVideoTexture);Ie(Y,g);let te;const Re=g.mipmaps,Ue=g.isVideoTexture!==!0,Ye=ae.__version===void 0||$===!0,w=ee.dataReady,ne=T(g,q);if(g.isDepthTexture)re=D(g.format===Kn,g.type),Ye&&(Ue?t.texStorage2D(i.TEXTURE_2D,1,re,q.width,q.height):t.texImage2D(i.TEXTURE_2D,0,re,q.width,q.height,0,fe,ge,null));else if(g.isDataTexture)if(Re.length>0){Ue&&Ye&&t.texStorage2D(i.TEXTURE_2D,ne,re,Re[0].width,Re[0].height);for(let W=0,pe=Re.length;W<pe;W++)te=Re[W],Ue?w&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,te.width,te.height,fe,ge,te.data):t.texImage2D(i.TEXTURE_2D,W,re,te.width,te.height,0,fe,ge,te.data);g.generateMipmaps=!1}else Ue?(Ye&&t.texStorage2D(i.TEXTURE_2D,ne,re,q.width,q.height),w&&ie(g,q,fe,ge)):t.texImage2D(i.TEXTURE_2D,0,re,q.width,q.height,0,fe,ge,q.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ue&&Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ne,re,Re[0].width,Re[0].height,q.depth);for(let W=0,pe=Re.length;W<pe;W++)if(te=Re[W],g.format!==$t)if(fe!==null)if(Ue){if(w)if(g.layerUpdates.size>0){const se=xo(te.width,te.height,g.format,g.type);for(const j of g.layerUpdates){const Me=te.data.subarray(j*se/te.data.BYTES_PER_ELEMENT,(j+1)*se/te.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,j,te.width,te.height,1,fe,Me)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,te.width,te.height,q.depth,fe,te.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,W,re,te.width,te.height,q.depth,0,te.data,0,0);else Te("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ue?w&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,te.width,te.height,q.depth,fe,ge,te.data):t.texImage3D(i.TEXTURE_2D_ARRAY,W,re,te.width,te.height,q.depth,0,fe,ge,te.data)}else{Ue&&Ye&&t.texStorage2D(i.TEXTURE_2D,ne,re,Re[0].width,Re[0].height);for(let W=0,pe=Re.length;W<pe;W++)te=Re[W],g.format!==$t?fe!==null?Ue?w&&t.compressedTexSubImage2D(i.TEXTURE_2D,W,0,0,te.width,te.height,fe,te.data):t.compressedTexImage2D(i.TEXTURE_2D,W,re,te.width,te.height,0,te.data):Te("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ue?w&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,te.width,te.height,fe,ge,te.data):t.texImage2D(i.TEXTURE_2D,W,re,te.width,te.height,0,fe,ge,te.data)}else if(g.isDataArrayTexture)if(Ue){if(Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ne,re,q.width,q.height,q.depth),w)if(g.layerUpdates.size>0){const W=xo(q.width,q.height,g.format,g.type);for(const pe of g.layerUpdates){const se=q.data.subarray(pe*W/q.data.BYTES_PER_ELEMENT,(pe+1)*W/q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,pe,q.width,q.height,1,fe,ge,se)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,q.width,q.height,q.depth,fe,ge,q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,re,q.width,q.height,q.depth,0,fe,ge,q.data);else if(g.isData3DTexture)Ue?(Ye&&t.texStorage3D(i.TEXTURE_3D,ne,re,q.width,q.height,q.depth),w&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,q.width,q.height,q.depth,fe,ge,q.data)):t.texImage3D(i.TEXTURE_3D,0,re,q.width,q.height,q.depth,0,fe,ge,q.data);else if(g.isFramebufferTexture){if(Ye)if(Ue)t.texStorage2D(i.TEXTURE_2D,ne,re,q.width,q.height);else{let W=q.width,pe=q.height;for(let se=0;se<ne;se++)t.texImage2D(i.TEXTURE_2D,se,re,W,pe,0,fe,ge,null),W>>=1,pe>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){const W=i.canvas;if(W.hasAttribute("layoutsubtree")||W.setAttribute("layoutsubtree","true"),q.parentNode!==W){W.appendChild(q),p.add(g),W.onpaint=De=>{const ht=De.changedElements;for(const je of p)ht.includes(je.image)&&(je.needsUpdate=!0)},W.requestPaint();return}const pe=0,se=i.RGBA,j=i.RGBA,Me=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,pe,se,j,Me,q),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Re.length>0){if(Ue&&Ye){const W=ot(Re[0]);t.texStorage2D(i.TEXTURE_2D,ne,re,W.width,W.height)}for(let W=0,pe=Re.length;W<pe;W++)te=Re[W],Ue?w&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,fe,ge,te):t.texImage2D(i.TEXTURE_2D,W,re,fe,ge,te);g.generateMipmaps=!1}else if(Ue){if(Ye){const W=ot(q);t.texStorage2D(i.TEXTURE_2D,ne,re,W.width,W.height)}w&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,fe,ge,q)}else t.texImage2D(i.TEXTURE_2D,0,re,fe,ge,q);u(g)&&y(Y),ae.__version=ee.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function we(M,g,N){if(g.image.length!==6)return;const Y=K(M,g),$=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,M.__webglTexture,i.TEXTURE0+N);const ee=n.get($);if($.version!==ee.__version||Y===!0){t.activeTexture(i.TEXTURE0+N);const ae=Ve.getPrimaries(Ve.workingColorSpace),k=g.colorSpace===Un?null:Ve.getPrimaries(g.colorSpace),q=g.colorSpace===Un||ae===k?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,q);const fe=g.isCompressedTexture||g.image[0].isCompressedTexture,ge=g.image[0]&&g.image[0].isDataTexture,re=[];for(let j=0;j<6;j++)!fe&&!ge?re[j]=m(g.image[j],!0,r.maxCubemapSize):re[j]=ge?g.image[j].image:g.image[j],re[j]=oe(g,re[j]);const te=re[0],Re=s.convert(g.format,g.colorSpace),Ue=s.convert(g.type),Ye=E(g.internalFormat,Re,Ue,g.normalized,g.colorSpace),w=g.isVideoTexture!==!0,ne=ee.__version===void 0||Y===!0,W=$.dataReady;let pe=T(g,te);Ie(i.TEXTURE_CUBE_MAP,g);let se;if(fe){w&&ne&&t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,Ye,te.width,te.height);for(let j=0;j<6;j++){se=re[j].mipmaps;for(let Me=0;Me<se.length;Me++){const De=se[Me];g.format!==$t?Re!==null?w?W&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,De.width,De.height,Re,De.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,Ye,De.width,De.height,0,De.data):Te("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):w?W&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,De.width,De.height,Re,Ue,De.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,Ye,De.width,De.height,0,Re,Ue,De.data)}}}else{if(se=g.mipmaps,w&&ne){se.length>0&&pe++;const j=ot(re[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,Ye,j.width,j.height)}for(let j=0;j<6;j++)if(ge){w?W&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,re[j].width,re[j].height,Re,Ue,re[j].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ye,re[j].width,re[j].height,0,Re,Ue,re[j].data);for(let Me=0;Me<se.length;Me++){const ht=se[Me].image[j].image;w?W&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,ht.width,ht.height,Re,Ue,ht.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,Ye,ht.width,ht.height,0,Re,Ue,ht.data)}}else{w?W&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Re,Ue,re[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ye,Re,Ue,re[j]);for(let Me=0;Me<se.length;Me++){const De=se[Me];w?W&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,Re,Ue,De.image[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,Ye,Re,Ue,De.image[j])}}}u(g)&&y(i.TEXTURE_CUBE_MAP),ee.__version=$.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function Ae(M,g,N,Y,$,ee){const ae=s.convert(N.format,N.colorSpace),k=s.convert(N.type),q=E(N.internalFormat,ae,k,N.normalized,N.colorSpace),fe=n.get(g),ge=n.get(N);if(ge.__renderTarget=g,!fe.__hasExternalTextures){const re=Math.max(1,g.width>>ee),te=Math.max(1,g.height>>ee);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?t.texImage3D($,ee,q,re,te,g.depth,0,ae,k,null):t.texImage2D($,ee,q,re,te,0,ae,k,null)}t.bindFramebuffer(i.FRAMEBUFFER,M),Ge(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,$,ge.__webglTexture,0,gt(g)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,$,ge.__webglTexture,ee),t.bindFramebuffer(i.FRAMEBUFFER,null)}function st(M,g,N){if(i.bindRenderbuffer(i.RENDERBUFFER,M),g.depthBuffer){const Y=g.depthTexture,$=Y&&Y.isDepthTexture?Y.type:null,ee=D(g.stencilBuffer,$),ae=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Ge(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,gt(g),ee,g.width,g.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,gt(g),ee,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ee,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ae,i.RENDERBUFFER,M)}else{const Y=g.textures;for(let $=0;$<Y.length;$++){const ee=Y[$],ae=s.convert(ee.format,ee.colorSpace),k=s.convert(ee.type),q=E(ee.internalFormat,ae,k,ee.normalized,ee.colorSpace);Ge(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,gt(g),q,g.width,g.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,gt(g),q,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,q,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ze(M,g,N){const Y=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,M),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=n.get(g.depthTexture);if($.__renderTarget=g,(!$.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),Y){if($.__webglInit===void 0&&($.__webglInit=!0,g.depthTexture.addEventListener("dispose",P)),$.__webglTexture===void 0){$.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),Ie(i.TEXTURE_CUBE_MAP,g.depthTexture);const fe=s.convert(g.depthTexture.format),ge=s.convert(g.depthTexture.type);let re;g.depthTexture.format===yn?re=i.DEPTH_COMPONENT24:g.depthTexture.format===Kn&&(re=i.DEPTH24_STENCIL8);for(let te=0;te<6;te++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,re,g.width,g.height,0,fe,ge,null)}}else J(g.depthTexture,0);const ee=$.__webglTexture,ae=gt(g),k=Y?i.TEXTURE_CUBE_MAP_POSITIVE_X+N:i.TEXTURE_2D,q=g.depthTexture.format===Kn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===yn)Ge(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,k,ee,0,ae):i.framebufferTexture2D(i.FRAMEBUFFER,q,k,ee,0);else if(g.depthTexture.format===Kn)Ge(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,k,ee,0,ae):i.framebufferTexture2D(i.FRAMEBUFFER,q,k,ee,0);else throw new Error("Unknown depthTexture format")}function Ze(M){const g=n.get(M),N=M.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==M.depthTexture){const Y=M.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),Y){const $=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,Y.removeEventListener("dispose",$)};Y.addEventListener("dispose",$),g.__depthDisposeCallback=$}g.__boundDepthTexture=Y}if(M.depthTexture&&!g.__autoAllocateDepthBuffer)if(N)for(let Y=0;Y<6;Y++)ze(g.__webglFramebuffer[Y],M,Y);else{const Y=M.texture.mipmaps;Y&&Y.length>0?ze(g.__webglFramebuffer[0],M,0):ze(g.__webglFramebuffer,M,0)}else if(N){g.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[Y]),g.__webglDepthbuffer[Y]===void 0)g.__webglDepthbuffer[Y]=i.createRenderbuffer(),st(g.__webglDepthbuffer[Y],M,!1);else{const $=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ee=g.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,ee),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ee)}}else{const Y=M.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),st(g.__webglDepthbuffer,M,!1);else{const $=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ee=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ee),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ee)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function it(M,g,N){const Y=n.get(M);g!==void 0&&Ae(Y.__webglFramebuffer,M,M.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&Ze(M)}function Be(M){const g=M.texture,N=n.get(M),Y=n.get(g);M.addEventListener("dispose",v);const $=M.textures,ee=M.isWebGLCubeRenderTarget===!0,ae=$.length>1;if(ae||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=g.version,a.memory.textures++),ee){N.__webglFramebuffer=[];for(let k=0;k<6;k++)if(g.mipmaps&&g.mipmaps.length>0){N.__webglFramebuffer[k]=[];for(let q=0;q<g.mipmaps.length;q++)N.__webglFramebuffer[k][q]=i.createFramebuffer()}else N.__webglFramebuffer[k]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){N.__webglFramebuffer=[];for(let k=0;k<g.mipmaps.length;k++)N.__webglFramebuffer[k]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(ae)for(let k=0,q=$.length;k<q;k++){const fe=n.get($[k]);fe.__webglTexture===void 0&&(fe.__webglTexture=i.createTexture(),a.memory.textures++)}if(M.samples>0&&Ge(M)===!1){N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let k=0;k<$.length;k++){const q=$[k];N.__webglColorRenderbuffer[k]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[k]);const fe=s.convert(q.format,q.colorSpace),ge=s.convert(q.type),re=E(q.internalFormat,fe,ge,q.normalized,q.colorSpace,M.isXRRenderTarget===!0),te=gt(M);i.renderbufferStorageMultisample(i.RENDERBUFFER,te,re,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+k,i.RENDERBUFFER,N.__webglColorRenderbuffer[k])}i.bindRenderbuffer(i.RENDERBUFFER,null),M.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),st(N.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ee){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Ie(i.TEXTURE_CUBE_MAP,g);for(let k=0;k<6;k++)if(g.mipmaps&&g.mipmaps.length>0)for(let q=0;q<g.mipmaps.length;q++)Ae(N.__webglFramebuffer[k][q],M,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+k,q);else Ae(N.__webglFramebuffer[k],M,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+k,0);u(g)&&y(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ae){for(let k=0,q=$.length;k<q;k++){const fe=$[k],ge=n.get(fe);let re=i.TEXTURE_2D;(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(re=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,ge.__webglTexture),Ie(re,fe),Ae(N.__webglFramebuffer,M,fe,i.COLOR_ATTACHMENT0+k,re,0),u(fe)&&y(re)}t.unbindTexture()}else{let k=i.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(k=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(k,Y.__webglTexture),Ie(k,g),g.mipmaps&&g.mipmaps.length>0)for(let q=0;q<g.mipmaps.length;q++)Ae(N.__webglFramebuffer[q],M,g,i.COLOR_ATTACHMENT0,k,q);else Ae(N.__webglFramebuffer,M,g,i.COLOR_ATTACHMENT0,k,0);u(g)&&y(k),t.unbindTexture()}M.depthBuffer&&Ze(M)}function mt(M){const g=M.textures;for(let N=0,Y=g.length;N<Y;N++){const $=g[N];if(u($)){const ee=b(M),ae=n.get($).__webglTexture;t.bindTexture(ee,ae),y(ee),t.unbindTexture()}}}const at=[],Nt=[];function C(M){if(M.samples>0){if(Ge(M)===!1){const g=M.textures,N=M.width,Y=M.height;let $=i.COLOR_BUFFER_BIT;const ee=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=n.get(M),k=g.length>1;if(k)for(let fe=0;fe<g.length;fe++)t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ae.__webglMultisampledFramebuffer);const q=M.texture.mipmaps;q&&q.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglFramebuffer);for(let fe=0;fe<g.length;fe++){if(M.resolveDepthBuffer&&(M.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),k){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ae.__webglColorRenderbuffer[fe]);const ge=n.get(g[fe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ge,0)}i.blitFramebuffer(0,0,N,Y,0,0,N,Y,$,i.NEAREST),c===!0&&(at.length=0,Nt.length=0,at.push(i.COLOR_ATTACHMENT0+fe),M.depthBuffer&&M.resolveDepthBuffer===!1&&(at.push(ee),Nt.push(ee),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Nt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,at))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),k)for(let fe=0;fe<g.length;fe++){t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,ae.__webglColorRenderbuffer[fe]);const ge=n.get(g[fe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,ge,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&c){const g=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function gt(M){return Math.min(r.maxSamples,M.samples)}function Ge(M){const g=n.get(M);return M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function tt(M){const g=a.render.frame;d.get(M)!==g&&(d.set(M,g),M.update())}function oe(M,g){const N=M.colorSpace,Y=M.format,$=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||N!==Pr&&N!==Un&&(Ve.getTransfer(N)===qe?(Y!==$t||$!==Gt)&&Te("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):We("WebGLTextures: Unsupported texture color space:",N)),g}function ot(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(l.width=M.naturalWidth||M.width,l.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(l.width=M.displayWidth,l.height=M.displayHeight):(l.width=M.width,l.height=M.height),l}this.allocateTextureUnit=H,this.resetTextureUnits=X,this.getTextureUnits=Z,this.setTextureUnits=U,this.setTexture2D=J,this.setTexture2DArray=Q,this.setTexture3D=ce,this.setTextureCube=xe,this.rebindTextures=it,this.setupRenderTarget=Be,this.updateRenderTargetMipmap=mt,this.updateMultisampleRenderTarget=C,this.setupDepthRenderbuffer=Ze,this.setupFrameBufferTexture=Ae,this.useMultisampledRTT=Ge,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function ep(i,e){function t(n,r=Un){let s;const a=Ve.getTransfer(r);if(n===Gt)return i.UNSIGNED_BYTE;if(n===xa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===va)return i.UNSIGNED_SHORT_5_5_5_1;if(n===rl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===sl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===nl)return i.BYTE;if(n===il)return i.SHORT;if(n===Bi)return i.UNSIGNED_SHORT;if(n===_a)return i.INT;if(n===cn)return i.UNSIGNED_INT;if(n===rn)return i.FLOAT;if(n===Sn)return i.HALF_FLOAT;if(n===al)return i.ALPHA;if(n===ol)return i.RGB;if(n===$t)return i.RGBA;if(n===yn)return i.DEPTH_COMPONENT;if(n===Kn)return i.DEPTH_STENCIL;if(n===ll)return i.RED;if(n===Ma)return i.RED_INTEGER;if(n===$n)return i.RG;if(n===Sa)return i.RG_INTEGER;if(n===ya)return i.RGBA_INTEGER;if(n===Sr||n===yr||n===Er||n===Tr)if(a===qe)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Sr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===yr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Er)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Tr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Sr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===yr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Er)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Tr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Fs||n===Os||n===Bs||n===zs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Fs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Os)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Bs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===zs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Gs||n===Vs||n===Hs||n===ks||n===Ws||n===Rr||n===Xs)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Gs||n===Vs)return a===qe?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Hs)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===ks)return s.COMPRESSED_R11_EAC;if(n===Ws)return s.COMPRESSED_SIGNED_R11_EAC;if(n===Rr)return s.COMPRESSED_RG11_EAC;if(n===Xs)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Ys||n===qs||n===Ks||n===Zs||n===js||n===$s||n===Js||n===Qs||n===ea||n===ta||n===na||n===ia||n===ra||n===sa)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ys)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===qs)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ks)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Zs)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===js)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===$s)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Js)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Qs)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ea)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ta)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===na)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ia)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ra)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===sa)return a===qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===aa||n===oa||n===la)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===aa)return a===qe?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===oa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===la)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ca||n===ha||n===wr||n===ua)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===ca)return s.COMPRESSED_RED_RGTC1_EXT;if(n===ha)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===wr)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ua)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===zi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const tp=`
void main() {
